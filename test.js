...
function testLength(t, word, expectedLength) {
	t.is(p.getLength(word), expectedLength);
}
...
test('Test Length of the int array', testLength, '1234567', 5040);

test('Test \'a\' permutations', testPermutations, 'a', 'a');
...
test('Test integer permutations', testPermutations, '7890', [
	...
	'8790', '8709', '8970', '8907', '8079', '8097',
	'9780', '9708', '9870', '9807', '9078', '9087',
	'0789', '0798', '0879', '0897', '0978', '0987'
]);
